...
-- PARAMETRO INT É TAMANHO DA MAIOR LINHA 
...
justificarUmaLinha l n 
 |numeroEspacos l == 0 = l
 |otherwise = insereEspacos (div (n - (tamanhoLinha l)) (numeroEspacos l)) (mod (n - (tamanhoLinha l)) (numeroEspacos l)) l
